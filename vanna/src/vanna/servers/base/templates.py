...
<body>
    <div class="max-w-6xl mx-auto p-5">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-vanna-navy mb-2 font-serif">StockJarvis</h1>
            <p class="text-lg font-mono font-bold text-vanna-teal mb-4">FILINGS CHAT</p>
            <p class="text-slate-600 mb-4">Ask about company figures in the filings database.</p>
